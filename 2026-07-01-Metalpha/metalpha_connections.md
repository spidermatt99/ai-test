...
graph TD
    %% Core Nodes
    Metalpha["Metalpha Tech Holding Ltd.<br/>(NASDAQ: MATH)"]
    Adrian["Adrian Wang / Wang Bingzhong<br/>(Founder, Chairman & CEO)"]
    Xisha["Xisha Hu<br/>(CEO of Metalpha Limited, BVI)"]
    
    %% Key Shareholders & Partners
    Antalpha["Antalpha / Polaris / Northstar<br/>(Web3 Partner)"]
    Gortune["Gortune Investment Co.<br/>(Guangdong State-Backed)"]
    Avenir["Avenir Tech Limited"]
    NDV["NextGen Digital Venture"]
    
    %% Behind the Scenes / Powerful Figures
    JihanWu["Jihan Wu<br/>(Crypto Billionaire, Bitmain/Matrixport)"]
    LiLin["Li Lin<br/>(Huobi Founder)"]
    WeiXu["Wei Xu<br/>(Gortune Controller)"]
    JasonHuang["Jason Huang<br/>(NDV Founder)"]
    JosephTsai["Joseph Tsai & Jack Ma<br/>(Alibaba Founders)"]
    BluePool["Blue Pool Capital<br/>(Tsai/Ma Family Office)"]
    
    %% Relationships
    Metalpha -->|Founder, Chairman & CEO| Adrian
    Adrian ---|Spouse Relationship| Xisha
    Xisha -->|Controls 6.47% via| MetaSphere["MetaSphere Limited"]
    MetaSphere -.->|Shareholder| Metalpha
    Metalpha -->|Wholly Owned| MetalphaSG["Metalpha Pte. Ltd. (Singapore)"]
    MetalphaSG -->|Director| HuJing["Hu Jing<br/>(Director & 2.12% Shareholder)"]
    
    Gortune -->|Controlled by| WeiXu
    Gortune -.->|Holds 6.91%| Metalpha
    
    Avenir -.->|Holds 1.38%| Metalpha
    Avenir -->|Controlled by| LiLin
    
    Antalpha -->|Joint Venture & 49% former stake in| MetalphaLimited["Metalpha Limited<br/>(BVI Trading Sub)"]
    Antalpha -->|Lending underwritten by| Northstar["Northstar Digital Holding"]
    Northstar -->|Owned by Trust for| JihanWu
    
    NDV -->|Joint Crypto Funds| Metalpha
    NDV -->|Founded by| JasonHuang
    JasonHuang -->|Former Associate| BluePool
    BluePool -->|Co-founded by| JosephTsai
    
    classDef core fill:#1e293b,stroke:#334155,stroke-width:2px,color:#fff;
    classDef state fill:#0f172a,stroke:#3b82f6,stroke-width:2px,color:#fff;
    classDef billionaire fill:#581c87,stroke:#a855f7,stroke-width:2px,color:#fff;
    class Metalpha,Adrian,Xisha core;
    class Gortune state;
    class JihanWu,LiLin,JosephTsai billionaire;
```
